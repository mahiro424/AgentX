...
| M2-R1 | [#30](https://github.com/mahiro424/AgentX/issues/30) 按完整工作链路调整材料、表格与文档切片 | headless | #20 已合入 m2 | ready-for-agent；仅修订已批准分期与门禁，不实现产品功能 |
| M2-02 | [#22](https://github.com/mahiro424/AgentX/issues/22) 非项目材料与文本预览续改闭环 | workbench | #21、#30 合入 m2 | ready-for-human：等待 #30，不要求重复视觉确认 |
| M2-03 | [#23](https://github.com/mahiro424/AgentX/issues/23) 表格处理、预览与续改闭环 | workbench | #22 合入 m2 | ready-for-human：等待依赖，不要求重复视觉确认 |
