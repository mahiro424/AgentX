...
test('IPC：仅暴露产品桥，拒绝非法偏好且不更改原配置', { timeout: 20000 }, async t => {
  ...
  assert.deepEqual(surface, { keys: ['answerExecutionApproval', 'answerExit', 'chooseProject', 'continueExecution', 'copyOutput', 'fetchModelCatalog', 'getAppInfo', 'getDraft', 'getExecution', 'getExitState', 'getModelSettings', 'getPreferences', 'getReconciliation', 'getTaskHistory', 'getTaskResults', 'getWorkspace', 'onExecutionChanged', 'onExitChanged', 'onModelSettingsChanged', 'onWorkspaceChanged', 'renameProject', 'renameTask', 'revealModelKey', 'saveDraft', 'saveModelKey', 'savePreferences', 'setActiveModel', 'setModelConnectionEnabled', 'setModelSettingsVisible', 'setSelectedModels', 'startExecution', 'steerExecution', 'stopExecution', 'testModel'], frozen: true, nodeAccess: 'undefined' });
