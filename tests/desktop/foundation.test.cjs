...
test('IPC：仅暴露产品桥，拒绝非法偏好且不更改原配置', { timeout: 20000 }, async t => {
  ...
  assert.deepEqual(surface, { keys: ['answerExecutionApproval', 'chooseProject', 'fetchModelCatalog', 'getAppInfo', 'getDraft', 'getExecution', 'getModelSettings', 'getPreferences', 'getWorkspace', 'onExecutionChanged', 'onModelSettingsChanged', 'onWorkspaceChanged', 'renameProject', 'revealModelKey', 'saveDraft', 'saveModelKey', 'savePreferences', 'setActiveModel', 'setModelConnectionEnabled', 'setModelSettingsVisible', 'setSelectedModels', 'startExecution', 'steerExecution', 'stopExecution', 'testModel'], frozen: true, nodeAccess: 'undefined' });
